#!/usr/bin/env python
## This should be in OpenNMT-py/onmt/translate/ folder
...
class Translator(object):
    ...
    def translate(
        ...
        for batch in data_iter:
            ...
            for trans in translations:
                ...
                if attn_debug:
                    ...
                    # print("======Attn type ======", type(attns))
                    # print("=====Attn ===========", attns)
                    # print("srcs type", type(srcs))
                    # print("srcs", srcs)
        ...
        # print("=======================================")
        # print("all_scores type", type(all_scores))
        # print("all_predictions type", type(all_scores))
        # print("All_scores", all_scores)
        # print("All_predictions", all_predictions)
        return all_scores, all_predictions, attn_df
